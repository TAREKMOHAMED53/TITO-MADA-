...
<div class="container my-5 py-5">
    <nav class="text-center">
        <button class="btn" oneclick="filterTask('all')">All</button>
        <button class="btn" oneclick="filterTask('completed')">Completed</button>
        <button class="btn" oneclick="filterTask('uncompleted')">Un Completed</button>
    </nav>
